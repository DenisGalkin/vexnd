...
from vexnd_app.plans import format_usd_amount, plan_catalog, plan_details
from vexnd_app.services.coupons import coupon_pricing, normalize_coupon_code
from vexnd_app.web import favicon, get_locale, robots_txt, sitemap_xml, translate


POLICY_DATE_RU = "30 марта 2026"
POLICY_DATE_EN = "March 30, 2026"
POLICY_SOURCES_DIR = Path(__file__).resolve().parents[2] / "templates" / "legal_sources"
