...
from vexnd_app.models import PaymentIntent
from vexnd_app.security.webhooks import provider_error_id, secrets_match
from vexnd_app.services.coupons import coupon_pricing, create_intent_pricing
from vexnd_app.services.payment_intents import create_intent_with_pricing
from vexnd_app.services.payments.apays import apays_credentials, apays_md5, apays_process_approved, create_apays_order
from vexnd_app.services.payments.crystalpay import create_crystal_invoice, crystal_invoice_info, crystalpay_process_paid_invoice, crystalpay_webhook_impl
from vexnd_app.services.payments.cryptobot import create_crypto_invoice, cryptobot_process_paid_invoice, cryptobot_verify_webhook_signature
from vexnd_app.services.payments.heleket import create_heleket_invoice, heleket_process_paid, heleket_webhook_impl
from vexnd_app.services.payments.platega import create_platega_transaction, platega_process_paid_transaction, platega_webhook_impl
from vexnd_app.web import return_intent_visible, return_redirect_target, translate
...
def start_payment(method):
    ...
    try:
        ...
        plan_int = 1
    from vexnd_app.plans import plan_details
