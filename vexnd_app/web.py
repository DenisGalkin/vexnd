...
from vexnd_app.models import Subscription, User, UserSecurity
from vexnd_app.services.referrals import get_or_create_referral_code, mask_email
from vexnd_app.services.security import client_ip, csrf_token, device_fingerprint, ensure_db_schema, require_csrf
...
def init_app(app) -> None:
    ...
    from vexnd_app.plans import plan_duration_label
